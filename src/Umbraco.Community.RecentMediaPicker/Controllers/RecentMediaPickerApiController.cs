...
namespace Umbraco.Community.RecentMediaPicker.Controllers
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "Umbraco.Community.RecentMediaPicker")]
    public class RecentMediaPickerApiController : RecentMediaPickerApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public RecentMediaPickerApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
